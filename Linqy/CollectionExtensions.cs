...
namespace Linqy
{
    ...
    public static class CollectionExtensions
    {
        ...
        /// <summary>
        /// Groups elements into groups using a delegate to determine if the current element belongs to the same group
        ...
        /// </param>
        /// <returns>
        /// A collection of <see cref="List{T}"/>, each containing one group.
        /// </returns>
        /// <exception cref="ArgumentNullException">
        /// <para><paramref name="collection"/> is <c>null</c>.</para>
        /// <para>- or -</para>
        ...
        /// </exception>
        [NotNull]
        public static IEnumerable<List<T>> GroupIf<T>([NotNull] this IEnumerable<T> collection, [NotNull] Func<T, T, bool> groupPredicate)
        {
            return new GroupIfEnumerable<T>(collection, groupPredicate);
        }
        ...
        {
            return new AggregateIfEnumerable<TElement, TAggregate, TAggregate>(collection, aggregatePredicate, () => default(TAggregate), aggregateFunc, aggregate => aggregate);
        }
        ...
        {
            return new AggregateIfEnumerable<TElement, TAggregate, TResult>(collection, aggregatePredicate, () => default(TAggregate), aggregateFunc, resultSelector);
        }
        ...
        /// <summary>
        /// Creates partitions from the underlying collection with a fixed number of element.s
        /// </summary>
        /// <typeparam name="T">
        /// The type of elements in the collection.
        /// </typeparam>
        ...
        /// </param>
        /// <returns>
        /// A collection of <see cref="List{T}"/>, one for each partition.
        /// </returns>
        /// <exception cref="ArgumentNullException">
        /// <para><paramref name="collection"/> is <c>null</c>.</para>
        /// </exception>
        ...
        /// </remarks>
        [NotNull]
        public static IEnumerable<List<T>> Partition<T>([NotNull] this IEnumerable<T> collection, int partitionSize)
        {
            return new PartitionEnumerable<T>(collection, partitionSize);
        }
